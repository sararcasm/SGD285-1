...
public class SGD285_1
{
    ...
    public static void Main()
    {
        UserQuote[] userQuotes = new UserQuote[]
	    {
           ...
           new UserQuote("Jennifer Baldwin", "I am no bird; and no net ensnares me; I am a free human being with an independent will. - Charlotte Bronte"),
           new UserQuote("Mayra Orlando", "Problems are not stop signs, they are guidelines.- Robert H. Schiuller"), /* By Karen Lopez: Sure can be! */
           new UserQuote("Forrest Wilkerson", "You miss 100% of the shots you never take- Wayne Gretzky"), /* By Karen Lopez: True! */
